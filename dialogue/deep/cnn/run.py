...
def train(data, params):
    if params["MODEL"] != "rand":
        ...
        word_vectors = KeyedVectors.load_word2vec_format("/Users/memray/Data/glove/GoogleNews-vectors-negative300.bin", binary=True)
    ...
    for e in range(params["EPOCH"]):
        ...
        for i in range(0, len(data["train_x"]), params["BATCH_SIZE"]):
            ...
            if float(model.fc.weight.norm().data.numpy()) > params["NORM_LIMIT"]:
...
def main():
    ...
    parser.add_argument("--save_model", default="T", help="whether saving model or not (T/F)")
    parser.add_argument("--early_stopping", default="T", help="whether to apply early stopping(T/F)")
